...
// ETLFileProcessingWorkflow workflow definition
func ETLFileProcessingWorkflow(ctx workflow.Context, fileName string) (err error) {
...
func processFile(ctx workflow.Context, fileName string) (err error) {
	...
	workflow.GetLogger(ctx).Info("processFile:", fileName)

	workflow.GetLogger(ctx).Info("processFile: creating session")
